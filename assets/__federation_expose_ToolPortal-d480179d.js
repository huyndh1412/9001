...
const remotesMap = {
'MasterApp':{url:'https://huyndh1412.github.io/9000/remoteEntry.js',format:'esm',from:'webpack'}
};
...
const __federation_var_MasterAppMasterStore = await __federation_method_getRemote("MasterApp" , "./MasterStore");
 let MasterStore = __federation_method_unwrapDefault(__federation_var_MasterAppMasterStore); 
function App() {
  const [count, setCount] = reactExports.useState(0);
  console.log(MasterStore);
  MasterStore.getStore().subscribe((val) => {
    console.log(val);
  });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => {
            ...
            MasterStore.updateStore("123123");
          },
          children: [
            "count is ",
            count
...
export { React as R, App as default, jsxRuntimeExports as j, reactExports as r };
